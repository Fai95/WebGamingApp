<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="myWebApplication.Parent.Register" %>
    ...
    <div id="center-page">
        ...
        <form id="form1" runat="server" style="text-align: end">
            ...
            <div class="col-xs-11 space-vert">
                <asp:Button ID="btSignup" runat="server" Class="btn btn-success" OnClick="Button1_Click" Text="تسجيل" />
            </div>
        </form>
    </div>
</body>
