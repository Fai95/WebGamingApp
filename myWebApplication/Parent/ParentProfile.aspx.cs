    ...
    public partial class ParentProfile : System.Web.UI.Page
    {
        ...
        protected void RefreshData()
        {
            ...
            try
            {
                ...
                string Query = "SELECT * FROM Parent WHERE Email = '" + user + "';";
        ...
        protected void EditFname_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("update Parent set First_name='" + newFname.Trim() + "' where Email='" + user + "';", con);
                    con.Open();
                    cmd.ExecuteNonQuery();
                }
        ...
        protected void SaveLname_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(CS))
                {
                    SqlCommand cmd = new SqlCommand("update Parent set Last_name='" + newLname.Trim() + "' where Email='" + user + "';", con);
                    con.Open();
                    cmd.ExecuteNonQuery();
                }
        ...
        protected void SavePh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(CS))
                {
                    SqlCommand cmd = new SqlCommand("update Parent set Phone_number='" + newPh.Trim() + "' where Email='" + user + "';", con);
                    con.Open();
                    cmd.ExecuteNonQuery();
                }
        ...
        protected void PassChangeButn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    using (SqlConnection con = new SqlConnection(CS))
                    {
                        SqlCommand cmd = new SqlCommand("update Parent set Password='" + newPass.Trim() + "' where Email='" + user + "'", con);
                        con.Open();
                        cmd.ExecuteNonQuery();
                    }
