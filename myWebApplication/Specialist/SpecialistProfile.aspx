<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecialistProfile.aspx.cs" Inherits="myWebApplication.Specialist.SpecialistProfile" %>
...
<body onload="dvProgress.style.display = 'none';">
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li id="profile" class="active" runat="server"><a href="SpecialistProfile.aspx">الملف الشخصي</a></li>
    ...
    <div id="center-page">
        ...
        <form id="form1" runat="server" style="text-align: end">
            ...
            <div class="col-xs-11">
                <asp:Label ID="center" runat="server"></asp:Label>
                <hr />
            </div>
